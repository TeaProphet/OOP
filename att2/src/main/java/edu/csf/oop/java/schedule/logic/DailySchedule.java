...
public class DailySchedule {
    ...
    public String receiveStringSchedule() {
    ...
    protected SubjectUnit receiveSubject(int subjectNum){
    ...
    protected boolean receiveIsNowLearning() throws WrongTimeCreated {
        if (schedule.size() == 0){
            return false;
        }
    ...
    protected SubjectUnit receiveCurrentSubject() throws WrongTimeCreated, SubjectNotFound {
        MyDigitalTime nowTime = TimeUtils.getNowTime();
        ...
        logger.info("ERROR: Current subject not found.");
    ...
    public ArrayList<SubjectUnit> getSchedule() {
        return schedule;
    }
}
