...
public class CourseSchedule {
    ...
    public GroupSchedule receiveScheduleForGroup(int groupNumber) throws GroupNotFoundException {
    ...
    public int receiveNumberOfStudents() {
        ...
        for (GroupSchedule groupSchedule: courseSchedule.values()) {
            numberOfStudents += groupSchedule.receiveNumberOfStudents();
        }
    ...
    public Collection<GroupSchedule> receiveGroupScheduleList(){
    ...
    public HashMap<Integer, GroupSchedule> getCourseSchedule() {
