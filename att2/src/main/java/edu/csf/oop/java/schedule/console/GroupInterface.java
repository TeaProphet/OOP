...
public class GroupInterface {
    public void start(GroupSchedule groupSchedule) {
        final String line = "==========================================================================";
            while (true) {
                try {
                ...
                switch (chosen) {
                    case 1 -> {
                        ...
                        System.out.println(groupSchedule.receiveWeeklySchedule());
                        System.out.println(line);
                    }
                    ...
                    case 3 -> {
                        if (groupSchedule.receiveIsNowLearning()) {
                            System.out.println(groupSchedule.receiveCurrentSubject());
                        } else {
    ...
    private static void findDailySchedule(GroupSchedule schedule, Scanner scanner) {
        ...
        while (true){
            try {
                ...
                dailySchedule = TimeUtils.numOfDayToNameOfDay(dayOfWeek) + ":\n" + schedule.getDailySchedule(dayOfWeek).receiveStringSchedule();
                break;
            } catch (Exception e) {
