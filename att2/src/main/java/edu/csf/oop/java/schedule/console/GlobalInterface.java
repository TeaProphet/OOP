...
import edu.csf.oop.java.schedule.utils.SaveJSON;
            ...
            try {
                ...
                switch (chosen) {
                    ...
                    case 3 -> {
                        System.out.print("Enter course number: ");
                        int courseNum = scanner.nextInt();
                        CourseInterface newCourseInterface = new CourseInterface();
                        newCourseInterface.start(scheduleHandler.getCourseSchedule(courseNum));
                    }
                    ...
                    case 6 -> {
                        scheduleHandler = (GlobalScheduleHandler) SaveJSON.restoreObjectFrom(Path.of("./saves/schedule.json").toFile(), GlobalScheduleHandler.class);
                    }

                    case 7 -> {
                        SaveJSON.saveObjectAs(scheduleHandler);
                        return;
                    }
