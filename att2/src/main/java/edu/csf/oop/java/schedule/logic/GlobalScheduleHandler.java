...
public class GlobalScheduleHandler {
    ...
    public HashMap<Integer, CourseSchedule> getAllCoursesSchedules() {
        return allCoursesSchedules;
    }
    ...
    public HashMap<Integer, Integer> getNumberOfStudentsForEachCourse() {
        ...
        for (int numberOfCourse: allCoursesSchedules.keySet()) {
            numberOfStudentsForEachCourse.put(numberOfCourse, allCoursesSchedules.get(numberOfCourse).receiveNumberOfStudents());
        }
