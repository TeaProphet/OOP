...
public class CourseInterface {
    protected void start(CourseSchedule courseSchedule){
        final String line = "==========================================================================";
        while (true){
            try {
                ...
                switch (chosen) {
                    ...
                    case 3 -> {
                        ...
                        int groupNum = scanner.nextInt();
                        GroupInterface newGroupInterface = new GroupInterface();
                        newGroupInterface.start(courseSchedule.receiveScheduleForGroup(groupNum));
                    }
                    case 4 -> {
                        System.out.print("Enter number of group: ");
                        int groupNum = scanner.nextInt();
